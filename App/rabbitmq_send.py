...
channel.basic_publish(exchange=FromCentralServiceToMicroService, routing_key=AddOrder, body=json_data)
# json_data = json.dumps(status)
# print(json_data)
# channel.basic_publish(exchange=FromCentralServiceToMicroService, routing_key=ChangeStatus, body=json_data)
